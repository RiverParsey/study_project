...
// module1-task120 создаем слайдер на сайте, вариант 2
...
// module1-task121 создаем навигацию для слайдов
...
// module1-task123 Регулярные выражения

// new RegExp('pattern', 'flags'); // класичесский метод создания регулярного выражения
// /patter/flags // используемый метод создания регулярного выражения

// const ans = prompt('Введите ваше имя');

// const reg = /n/ig;
// flag i найти вне зависимости от регистра
// flag g найти несколько вхождений
// flag m включает многострочный режим

// console.log(ans.search(reg)); // метод search ищет только первое совпадение
// console.log(ans.match(reg)); // при использовании match получаем массив данных

// const pass = prompt('Password');

// console.log(pass.replace(/./g, "*")); // паттерном точкой все введенные символы при выводе сменяются звездочкой

// console.log('12-34-56'.replace(/-/g, ':'));


// методы обьекта регулярного выражения RegExp

// const ans = prompt('Введите ваше число');

// const reg = /\d/ig;
// console.log(ans.match(reg)); // вернет либо правда либо ложь, если найдет в строке совпадение с паттерном
...
// \D class не числа/цифры
// \W class не буквы


// использование регулярных выражений в слайдере
// const slides = document.querySelectorAll('.offer__slide'),
//       slider = document.querySelector('.offer__slider'),
//       prev = document.querySelector('.offer__slider-prev'),
//       next = document.querySelector('.offer__slider-next'),
...
// next.addEventListener('click', () => {
//   if (offset == deleteNotDigits(width) * (slides -1)) {
//     offset = 0;
//   } else {
...
// prev.addEventListener('click', () => {
//   if (offset = 0) {
//     offset = deleteNotDigits(width) * (slides -1)
//   } else {
//     offset -= deleteNotDigits(width);
//   }
...
// module1-task124 создаем калькулятор на сайте часть 1
...
// getStaticInformation('.calculating__choose-big', 'calculating__choose-item_active');
...
// module1-task125 создаем калькулятор на сайте часть 2
...
// initLocalSettings('.calculating__choose-big div', 'calculating__choose-item_active');
...
// module1-task126 Геттеры и Сеттеры(свойства обьектов)
...
//   this.say = function() {
//     console.log(`Name of the user: ${this.name}, age ${userAge}`);
//   };
...
// module1-task131 собираем проект и фиксим баги

// так как у меня проект не написан фиксить и собирать нечего

// скорее всего перехожу к реакту и практическому курсу




// module1-task132 формируем портфолио на GitHub
...
// module1-task136 современные библиотеки и фреймворки
...
// module1-task138 функции генераторы
...
// module1-task140 Web Animations API
...
// module1-task143 работаем с готовым кодом

// только теоретический урок, достаточно полезный
